...
<template>
  <div class="bg-gray-50 min-h-screen">
    <PageHero
      title="Facilities"
      subtitle="Our laboratory is equipped with facilities for training the deep learning models and acquiring the materials data automatically."
    />
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div
          ...
          :key="facility.id"
          class="glass-card card-lift overflow-hidden"
        >
          <div class="h-96 bg-gray-200 overflow-hidden relative flex items-center justify-center">
            ...
            />
            <div v-else class="w-full h-full bg-gradient-to-br from-navy-800 to-navy-950 flex items-center justify-center">
              <svg class="w-24 h-24 text-white/60" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <div class="p-6">
            ...
            <div v-if="facility.manufacturer || facility.model" class="mb-4 text-sm bg-gray-50/80 p-3 rounded-md">
            ...
            <div v-if="facility.specifications && facility.specifications.length > 0">
              <h3 class="font-semibold gradient-text-strong mb-2">Specifications</h3>
              <ul class="space-y-1">
                <li
